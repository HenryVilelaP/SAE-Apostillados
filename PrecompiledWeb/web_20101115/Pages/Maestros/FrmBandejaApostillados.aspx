<%@ page language="C#" masterpagefile="~/MP/Main.master" autoeventwireup="true" inherits="Pages_Maestros_FrmBandejaApostillados, App_Web_nisepjg2" title="Untitled Page" %>
...
<hr />
        ...
        <tr><td>
                        ...
                        <tr>
                        <td class="etiqueta"><asp:Label ID="lblOperacionBancaria"  runat="server" Text="No Operación Bancaria" /></td>
                        <td><asp:TextBox runat="server" ID="txtNumeroOperacion" Width="70"></asp:TextBox></td>          
                        <td style=" height:30px;" class="etiqueta"><asp:Label ID="lblTipoDocumento"  runat="server" Text="Tipo de Documento" /></td>
                        <td colspan="3"><asp:DropDownList runat="server" ID="ddlTipoDocumento" ></asp:DropDownList>       </td>
       ...
       <table style="width:100%" cellpadding="0" cellspacing="0" >
          ...
          <div   class="DivGrillaBorde DivGrillaDimension">
            ...
            <AlternatingRowStyle CssClass="GridViewAlternatingRowStyle" />
             ...
             &nbsp; 
             <asp:ImageButton runat="server"  CommandArgument='<%# Eval("CODIGOACTUACION") %>' onclick="btnEdit_Click" ID="btnEdit" ToolTip="ir a imprimir Apostilla" Width="13" Height="13" ImageUrl="~/Images/Iconos/imprimir.gif" />
             &nbsp; 
...
<HeaderStyle CssClass="header-gridview"></HeaderStyle>
 ...
 <act:ModalPopupExtender 
                            ...
                            PopupControlID="pnModalPopupVistaApostilla"
                            DropShadow="False" 
                            TargetControlID="imgbtn" 
                             />
    <asp:Panel ID="pnModalPopupVistaApostilla" runat="server" CssClass="CajaDialogoGeneral stl_texto_sin_negrita" Width="8.7cm" Style="display:none">
     <ajax:UpdatePanel ID="upVistaApostilla" runat="server">
                                    ...
                                    <div style="position: absolute; top:2px;  left: 8cm;">
                                        ...
                                        <table border="0" cellspacing="2" cellpadding="0" style="width:8.7cm; height:9cm; background-color:White; font-family:Arial;"   class="td-left-apostilla td-right-apostilla td-bottom-apostilla td-top-apostilla">
                                        ...
                                        <td colspan="4">
                                                        ...
                                                        <td  valign="bottom" style=" height:40px; width:10cm;" align="center">
                                                                        ...
                                                                        <tr><td class="stl_apostillador_vista_sticker" ><asp:Label runat="server" ID="_lblApostilladorVista"></asp:Label></td>     </tr>
