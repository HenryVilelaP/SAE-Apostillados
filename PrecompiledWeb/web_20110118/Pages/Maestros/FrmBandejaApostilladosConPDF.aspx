<%@ page language="C#" masterpagefile="~/MP/Main.master" autoeventwireup="true" inherits="Pages_Maestros_FrmBandejaApostilladosConPDF, App_Web_gxtujfme" title="Untitled Page" %>
...
<HeaderStyle CssClass="header-gridview"></HeaderStyle>
      ...
      <td>
             ...
             <b> <asp:Label runat="server" ID="lblNumRegistrosXPagina"></asp:Label></b> 
      </td>
      </tr>
      </table>
     ...
     <ajax:UpdatePanel ID="upEdicionApostilla" runat="server">
                                    ...
                                    <div style="position: absolute; top:0px;  left: 420px;">
                                     ...
                                     <asp:Label runat="server" ID="lblNumeroApostilla" CssClass="numero_apostilla"></asp:Label> </td>
                                            ...
                                            <td class="etiqueta ">Ubicación</td>
                                            <td>
                                            <asp:DropDownList runat="server" ID="ddlUbicacionEdicion"></asp:DropDownList>
                                            </td>
                                            </tr>
                                            <tr  style="background:#ccc ; ">
                                            <td class="etiqueta ">Oficina</td>
                                            <td>
                                            <asp:DropDownList runat="server" ID="ddlOficinaApostilladorEdicion"></asp:DropDownList>
                                            </td>
                                            </tr>
                                            <tr  style="background:#ccc ; ">
                                            <td class="etiqueta ">Apostillador</td>
