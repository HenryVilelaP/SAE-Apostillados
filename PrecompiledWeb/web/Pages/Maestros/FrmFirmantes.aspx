<%@ page language="C#" masterpagefile="~/MP/Main.master" autoeventwireup="true" inherits="Pages_Maestros_frmFirmantes, App_Web_rjotmaad" %>
      ...
      <%--  <asp:Button runat="server" ID="brnBuscar" Text="Buscar" onclick="brnBuscar_Click" />--%>
       ...
       <table style="width:100%" cellpadding="0" cellspacing="0" >
          ...
          <div   class="DivGrillaBorde DivGrillaDimension">
            ...
            <asp:GridView runat="server"  ID="gvFirmante" Width="99%" ShowHeader="false"  AutoGenerateColumns="false" CssClass="DivGrillaBorde GridViewStyle" Height="37px"   >
