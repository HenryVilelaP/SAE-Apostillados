<%@ page language="C#" masterpagefile="~/MP/Main.master" autoeventwireup="true" inherits="Pages_Maestros_frmApostilladores, App_Web_jzxak1ig" %>
        ...
        <table style="width:100%" cellpadding="0" cellspacing="0" >
          ...
          <div   class="DivGrillaBorde DivGrillaDimension">
            ...
            <AlternatingRowStyle CssClass="GridViewAlternatingRowStyle" />
              ...
              <asp:TemplateField>
              <ItemTemplate>
              <asp:Image runat="server" ID="imgFirma"  />
