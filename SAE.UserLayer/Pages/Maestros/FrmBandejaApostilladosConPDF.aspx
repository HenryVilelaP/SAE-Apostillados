<%@ Page Language="C#" MasterPageFile="~/MP/Main.master" AutoEventWireup="true" CodeFile="FrmBandejaApostilladosConPDF.aspx.cs"
    Inherits="Pages_Maestros_FrmBandejaApostilladosConPDF" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphCuerpo" runat="Server">
                ...
                <table width="100%" border="0">
                    <tr>
                        <td style="height: 40px;">
                            <asp:Label runat="server" Text="Bandeja  de Apostillas Con PDF Asociado" ID="lbltitulo"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-CssClass="header-gridview" HeaderText="Opciones">
                                                        <ItemTemplate>
                                                            ...
                                                            &nbsp;
                                                            <asp:ImageButton runat="server" CommandArgument='<%# Eval("CODIGOACTUACION") %>'
                                                                OnClick="btnEdit_Click" ID="btnEdit" ToolTip="Editar Datos" Width="13" Height="13"
                                                                ImageUrl="~/Images/Iconos/data_edit.gif" />
                                                            &nbsp;
                                                            <asp:ImageButton runat="server" CommandArgument='<%# Eval("CODIGOACTUACION") %>'
                                    ...
                                    <td style="height: 30px" valign="middle">
                                        <table border="0" width="100%" class="cajaFiltros">
                                            ...
                                            <tr>
                                                <td>
                                                    <b>
                                                        <asp:Label runat="server" ID="lblNumRegistrosXPagina"></asp:Label></b>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
    ...
    <!--vista apostilla-->
    <!--  B = VENTANA ACTUALIZAR DATOS DE APOSTILLA -->
    <asp:Button runat="server" ID="imgbtn" Width="0" Height="0" />
    <act:ModalPopupExtender ID="mpeEditarApostilla" runat="server" BackgroundCssClass="BackgroundPopup"
        PopupControlID="pnModalPopupEditApostilla" DropShadow="False" TargetControlID="imgbtn" />
    <asp:Panel ID="pnModalPopupEditApostilla" runat="server" CssClass="CajaDialogoGeneral stl_texto_sin_negrita"
        ...
        <ajax:UpdatePanel ID="upEdicionApostilla" runat="server">
            <ContentTemplate>
                ...
                <table border="0" width="100%" class="bg_fondo_tabla">
                    <tr>
                        <td colspan="2" class="subTitulo header-gridview" align="center" style="height: 30px;">
                            Edici&oacute;n de Datos de Apostilla
                            <hr />
                        </td>
                        <tr>
                            <td class="etiqueta">
                            ...
                            <td>
                                ...
                                <asp:Label runat="server" ID="lblNumeroApostilla" CssClass="numero_apostilla"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="etiqueta">
                            ...
                            <td>
                                ...
                                <act:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtFechaEdicion"
                                    PopupButtonID="imbBtnCalEdicion" Format="dd/MM/yyyy">
                                </act:CalendarExtender>
                                <asp:ImageButton ID="imbBtnCalEdicion" runat="server" ImageUrl="~/Images/Iconos/ico_calendar.gif"
                                    ToolTip="Seleccione Fecha" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        <td>
                                            <asp:DropDownList runat="server" ID="ddlFirmante" OnSelectedIndexChanged="BuscarCargoAutoridad"
                                                AutoPostBack="true">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblCargoAutoridad" runat="server" CssClass="stl_descripcion_dato_ajax"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblEntidad" runat="server" CssClass="stl_descripcion_dato_ajax"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr style="background: #ccc;">
                            ...
                            <td>
                                <asp:DropDownList runat="server" ID="ddlUbicacionEdicion">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr style="background: #ccc;">
                            ...
                            <td>
                                <asp:DropDownList runat="server" ID="ddlOficinaApostilladorEdicion">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr style="background: #ccc;">
                            ...
                            <td>
                                <asp:DropDownList runat="server" ID="ddlApostilladorEdicion">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2" align="center" style="height: 50" valign="middle">
                                <asp:ImageButton runat="server" ID="btnRegistrar" ImageUrl="~/Images/Botones/BRegistrar_off.gif"
                                    OnClick="btnRegistrar_Click" ToolTip="Registar la actualización de Apostilla." />
                                &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
                                <asp:ImageButton runat="server" ID="btnCancelar" ImageUrl="~/Images/Botones/BCancelar_off.gif"
                                    OnClick="btnCancelar_Click" ToolTip="Cancelar actualización." />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
...
<asp:Button runat="server" ID="btn1" Width="0" Height="0" />
<act:ModalPopupExtender ID="mpeVerApostilla" runat="server" BackgroundCssClass="BackgroundPopup"
    PopupControlID="pnModalPopupVistaApostilla" DropShadow="False" TargetControlID="btn1" />
        ...
        <ajax:UpdatePanel ID="upVistaApostilla" runat="server">
            <ContentTemplate>
                <div style="position: absolute; top: 2px; left: 8cm;">
                    <asp:ImageButton runat="server" ToolTip="cerrar ventana" ImageUrl="~/Images/Iconos/close.png"
                        ID="ImageButton1" OnClick="imgVerCerrar_Click" />
                </div>
