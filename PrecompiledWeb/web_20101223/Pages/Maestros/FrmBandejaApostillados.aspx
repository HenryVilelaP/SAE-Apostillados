<%@ page language="C#" masterpagefile="~/MP/Main.master" autoeventwireup="true" inherits="Pages_Maestros_FrmBandejaApostillados, App_Web_rgv28-gm" title="Untitled Page" %>
...
<HeaderStyle CssClass="header-gridview"></HeaderStyle>
 ...
 <act:ModalPopupExtender 
                            ...
                            TargetControlID="imgbtn" 
                             />
    <asp:Panel ID="pnModalPopupVistaApostilla" runat="server" CssClass="CajaDialogoGeneral stl_texto_sin_negrita" Width="9cm" Style="display:none">
