<%@ page language="C#" masterpagefile="~/MP/Main.master" autoeventwireup="true" inherits="Pages_Maestros_frmApostilladores, App_Web_rjotmaad" %>
...
<hr />
        ...
        <table style="width:100%" cellpadding="0" cellspacing="0" >
                ...
                <td class="DivGrillaBorde">
                        ...
                        <td class="header-gridview" style="width:30%" align="center">Cargo</td>
          ...
          <div   class="DivGrillaBorde DivGrillaDimension">
            <asp:GridView runat="server"  ID="gvApostillador" Width="99%" ShowHeader="false" AutoGenerateColumns="false" CssClass="DivGrillaBorde GridViewStyle" Height="37px"   >
            <AlternatingRowStyle CssClass="GridViewAlternatingRowStyle" />
              ...
              <asp:BoundField DataField="CARGO"  ItemStyle-Width="30%" />
             ...
             <asp:ImageButton runat="server" ID="btnDelete" 
                      CommandArgument='<%# Eval("CODIGOAPOSTILLADOR") %>' CommandName="_delete" 
                      ImageUrl="~/Images/Iconos/data_delete_on.gif" onclick="btnDelete_Click" Visible="false"  />
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
             <asp:ImageButton runat="server"  CommandArgument='<%# Eval("CODIGOAPOSTILLADOR") %>' onclick="btnEdit_Click" ID="btnEdit" ImageUrl="~/Images/Iconos/data_edit_on.gif" />
              </ItemTemplate>
