<%@ Page Language="C#" MasterPageFile="~/MP/Main.master" AutoEventWireup="true" CodeFile="FrmRegistrarApostilla.aspx.cs" Inherits="Pages_Maestros_FrmRegistrarApostilla" Title="Untitled Page" %>
...
<div class="cajaabajo"> 
                        ...
                        <table border="0" width="100%"  class="bg_fondo_tabla">
                            ...
                            <td colspan="3" align="center" >
                                        ...
                                        <tr>
                                                <td valign="top">&nbsp;2.</td>
                                                <td valign="top" colspan="3" align="left"> ha sido firmado por / <span  >has been signed by</span>&nbsp;<asp:Label 
                                                        runat="server" ID="lblFirma" Font-Bold="True"></asp:Label></td>
                                        </tr>
                                        <tr>
                                                <td valign="top">&nbsp;3.</td>
                                                <td valign="top" colspan="3" align="left"> quién actua en calidad de / <span  >acting in the capacity of</span>&nbsp;<asp:Label 
                                                        runat="server" ID="lblCargoFirmante" Font-Bold="True"></asp:Label></td>
                                        </tr>
                                        <tr>
                                                <td valign="top">&nbsp;4.</td>
                                                <td valign="top" colspan="3" align="left">y está revestido del sello / timbre de / <span  >bears the seal / stamp of</span>&nbsp;<asp:Label 
                                                        runat="server" ID="Label4" Font-Bold="True"></asp:Label></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                                <td valign="top">&nbsp;5.</td>
                                                <td valign="top" align="left"> en / <span  >at</span> <asp:Label runat="server" 
                                                        ID="lblAt" Font-Bold="True"></asp:Label></td>
                                                <td valign="top"colspan="2" align="left">6.&nbsp;el / <span  >the</span> &nbsp;<asp:Label 
                                                        runat="server" ID="lblThe" Font-Bold="True"></asp:Label></td>
                                        </tr>
                                        <tr>
                                                <td valign="top">&nbsp;7.</td>
                                        ...
                                        <tr>
                                                <td valign="top">&nbsp;8.</td>
                                                <td valign="top"  colspan="3" align="left"> bajo el n&uacute;mero / <span  >N&#186;</span>&nbsp;<asp:Label 
                                                        runat="server" ID="lblNro" Font-Bold="True"></asp:Label></td>
                                        </tr>
                                        <tr>
                                                <td valign="top">&nbsp;9.</td>
