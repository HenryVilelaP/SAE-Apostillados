<%@ page language="C#" autoeventwireup="true" inherits="Pages_Maestros_FrmVistaApostilla, App_Web_rgv28-gm" %>
                ...
                <td>
                    <table style="width: 90mm; height: 90mm; margin: 0mm;" border="0" cellspacing="2"
                        ...
                        <tr>
                            ...
                            <td valign="top" colspan="3">
                                quién actua en calidad de / <span>acting in the capacity of</span>&nbsp;<asp:Label
                                    runat="server" ID="lblCargoFirmante"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top">
                        ...
                        <tr>
                            ...
                            <td valign="top">
                                en / <span>at</span>
                                <asp:Label runat="server" ID="lblAt"></asp:Label>
                            </td>
                            <td valign="top" colspan="2">
                                6.&nbsp;el / <span>the</span> &nbsp;<asp:Label runat="server" ID="lblThe"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top">
                        ...
                        <tr>
                            ...
                            <td valign="top" colspan="3">
                                bajo el n&uacute;mero / <span>N&#186;</span>&nbsp;<asp:Label runat="server" ID="lblNro"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top">
