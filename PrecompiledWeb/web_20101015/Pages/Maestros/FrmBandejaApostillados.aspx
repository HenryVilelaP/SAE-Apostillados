<%@ page language="C#" masterpagefile="~/MP/Main.master" autoeventwireup="true" inherits="Pages_Maestros_FrmBandejaApostillados, App_Web_jzxak1ig" title="Untitled Page" %>
       ...
       <table style="width:100%" cellpadding="0" cellspacing="0" >
          ...
          <div   class="DivGrillaBorde DivGrillaDimension">
            ...
            <AlternatingRowStyle CssClass="GridViewAlternatingRowStyle" />
             ...
             &nbsp; 
             <asp:ImageButton runat="server" CommandArgument='<%# Eval("CODIGOACTUACION") %>' ID="btnDelete"  CommandName="_delete" ToolTip="Eliminar Apostilla" ImageUrl="~/Images/Iconos/data_delete.gif" onclick="btnDelete_Click" />
             &nbsp; 
             <asp:ImageButton runat="server"  CommandArgument='<%# Eval("CODIGOACTUACION") %>' onclick="btnEdit_Click" ID="btnEdit" ToolTip="Editar Apostilla" ImageUrl="~/Images/Iconos/data_edit.gif" />
             &nbsp; 
             <asp:ImageButton runat="server"  CommandArgument='<%# Eval("NOMBREDOCUMENTO") %>' onclick="imgApos_Click" ID="btnView"  ToolTip="Ver Apostilla" Width="16" Height="16"  ImageUrl="~/Images/Iconos/data_view.gif" />
              </ItemTemplate>
